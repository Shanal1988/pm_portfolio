    ...
    <div className="min-h-screen">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-4xl font-bold text-navy-900 mb-3">Building in the problem space</h2>
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:border-navy-900 hover:shadow-lg transition-all duration-200">
            <div className="px-6 sm:px-8 py-6 sm:py-8">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-navy-900 mb-2 leading-tight">AddressGuard</h3>
              ...
              <div className="flex flex-wrap items-center gap-6 mt-8 pt-6 border-t border-gray-100">
                <a
                  ...
                  className="group inline-flex items-center text-navy-900 font-semibold hover:text-blue-600 transition-colors"
                >
                  View prototype
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 font-medium hover:text-navy-900 transition-colors"
                >
                  View on GitHub
                </a>
              </div>
